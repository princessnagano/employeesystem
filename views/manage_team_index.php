...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <?php if($user['role_id'] == '1' OR $user['role_id'] == '2'):?>
          <button type="button" class="btn btn add_team" data-toggle="modal" data-title="Add Employee" data-target="#add_team">Add Teams</button>
  <?php endif;?>
      </div>
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Team List</div>
        <div class="card-body">
          <div class="table-responsive table_div">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                <?php if(array_check($teams)):?>
                  <?php foreach($teams['teams'] as $key => $team):?>
                    <tr>
                      <td style="text-align: center;">
                        <?php $team_name = url_encode($team['team_name']);?>
                        <a href="<?php echo base_url().'employee/manage_team/'.$team_name?>"><?php echo $team['team_name'];?></a>
                      </td>
                  <?php endforeach;?>
                <?php endif;?>
              </tbody>
    ...
    <div class="modal fade new_modal" id="add_team" tabindex="-1" role="dialog" aria-labelledby="ADD Team TITLE" aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="row margin-top-10">
              ...
              <div class="col-md-8 col-sm-8" style="">
                <input name="team_name" class="form-control" id="team_name"/>         
              </div>
            </div>
            <div class="row margin-top-10">
              <div class="col-md-3 col-sm-1">
              ...
              <div class="col-md-8 col-sm-8" style="">
                <select name="team_leader" class="form-control default" id="team_leader">
                  ...
                  <?php if(array_check($team_leaders)):?>
                    <?php foreach($team_leaders as $key => $tl):?>
          ...
          <div class="modal-footer" id="modal-footer">
            <div id="action_wrapper">
              ...
              <button type="submit" class="btn btn-primary add_team">Add</button>
            </div>

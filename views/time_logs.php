        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                <?php if(isset($team_members) AND array_check($team_members)):?>
                  <?php foreach($team_members as $key => $tm):?>
                    <tr>
                      <td style="text-align: center;">
                        <?php $url_encode = url_encode($tm['username']);?>
                        <a href="<?php echo base_url() . 'time/employee_time_log/'.$url_encode ?>"><?php echo $tm['employee_id'];?></a>
                      </td>
                      <td style="text-align: center;">
                        <?php echo $tm['family_name'].', '.$tm['given_name'];?>
                      </td>
                      <td style="text-align: center;">
                        <?php echo isset($tm['team_name']) ? $tm['team_name'] : '';?>
                      </td>
                    </tr>
                  <?php endforeach;?>
                <?php endif;?>
